...
fun SetTotals(viewModel2: AccountPage, navController: NavHostController) {
    ...
    //totals by matching the keys of totals with the strings specified here
    for (entry in totals) {
    ...
    Column(
        ...
        if (miscellaneousTotal > miscellaneousOld) {
            Text(
                "you are over spending on miscellaneous items: $miscellaneousTotal",
                color = Color.Red
            )
        }
        //BUTTONS
        ...
        Button(onClick = {
            ...
            viewModel2.Food.value = ""
            viewModel2.Utility.value = ""
            viewModel2.Recreation.value = ""
            viewModel2.Transportation.value = ""
            viewModel2.Healthcare.value = ""
            viewModel2.Investments.value = ""
            viewModel2.PersonalCare.value = ""
            viewModel2.Miscellaneous.value = ""
        ...
        Text(
            "if you want to add an profile and you haven't added one before",
